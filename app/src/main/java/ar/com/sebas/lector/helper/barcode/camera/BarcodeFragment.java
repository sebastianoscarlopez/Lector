...
public class BarcodeFragment extends Fragment {
    ...
    static private BarcodeUpdateListener mBarcodeUpdateListener = null;
    ...
    public static void setListener(BarcodeUpdateListener listener) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int rc = ActivityCompat.checkSelfPermission(activity, android.Manifest.permission.CAMERA);
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        BarcodeTrackerFactory barcodeFactory = new BarcodeTrackerFactory(mGraphicOverlay, mBarcodeUpdateListener);
